...
public enum ErrorCode {
    ...
    PROFILE_NOT_CHANGED(HttpStatus.BAD_REQUEST, "PROFILE_NOT_CHANGED", "변경된 프로필 정보가 없습니다."),
    ...
    // Collection Trade
    COLLECTION_TRADE_REQUEST_NOT_FOUND(
            HttpStatus.NOT_FOUND,
            "COLLECTION_TRADE_REQUEST_NOT_FOUND",
            "존재하지 않는 도감 거래 요청입니다."
    ),
    COLLECTION_TRADE_ACCESS_DENIED(
            HttpStatus.FORBIDDEN,
            "COLLECTION_TRADE_ACCESS_DENIED",
            "도감 거래 요청에 접근할 권한이 없습니다."
    ),
    COLLECTION_TRADE_INVALID_STATUS(
            HttpStatus.CONFLICT,
            "COLLECTION_TRADE_INVALID_STATUS",
            "현재 상태에서는 거래 요청을 처리할 수 없습니다."
    ),
    COLLECTION_TRADE_DUPLICATE_REQUEST(
            HttpStatus.CONFLICT,
            "COLLECTION_TRADE_DUPLICATE_REQUEST",
            "이미 진행 중인 거래 요청이 있습니다."
    ),
    COLLECTION_TRADE_SELF_REQUEST(
            HttpStatus.BAD_REQUEST,
            "COLLECTION_TRADE_SELF_REQUEST",
            "자신의 도감 아이템에는 거래를 요청할 수 없습니다."
    ),
    COLLECTION_TRADE_OFFER_REQUIRED(
            HttpStatus.BAD_REQUEST,
            "COLLECTION_TRADE_OFFER_REQUIRED",
            "교환할 도감 아이템을 선택해주세요."
    ),
    COLLECTION_TRADE_INVALID_OFFER(
            HttpStatus.BAD_REQUEST,
            "COLLECTION_TRADE_INVALID_OFFER",
            "유효하지 않은 교환 아이템입니다."
    ),
    COLLECTION_TRADE_ALREADY_CONFIRMED(
            HttpStatus.CONFLICT,
            "COLLECTION_TRADE_ALREADY_CONFIRMED",
            "이미 거래 완료를 확인했습니다."
    ),
